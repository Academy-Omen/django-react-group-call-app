...
class NavigationBar extends Component {
  ...
  changePageTitle = () => {
    ...
    const { HOME_PATH, LOGIN_PATH, REGISTER_PATH } = AVAILABLE_PATHS;

    const { HOME_TITLE, LOGIN_TITLE, REGISTER_TITLE } = ALL_PATH_TITLES;
  ...
  menuAction = (event) => {
    ...
    const { HOME_PATH, LOGIN_PATH, REGISTER_PATH } = AVAILABLE_PATHS;
    const { HOME_TITLE, LOGIN_TITLE, REGISTER_TITLE, LOGOUT_TITLE } =
      ALL_PATH_TITLES;
    if (menu && history) {
      switch (menu) {
        case HOME_TITLE:
  ...
  render() {
    ...
    const menuItems = isUserLoggedIn
      ? [HOME_TITLE, LOGOUT_TITLE]
      : [HOME_TITLE, LOGIN_TITLE, REGISTER_TITLE];
    return (
